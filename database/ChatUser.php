...
class ChatUser
{
	...
	function setUserState($user_state)
	{
	...
	function getUserStateById($user_id)
	{
		$query = "
	...
	{
		$query = "
		INSERT INTO chat_user_table (user_name, user_email, user_password, user_profile, user_status, user_created_on, user_verification_code , user_state ) 
		VALUES (:user_name, :user_email, :user_password, :user_profile, :user_status, :user_created_on, :user_verification_code , :user_state)
		";
		$statement = $this->connect->prepare($query);
		...
		$statement->bindParam(':user_state' , $this->user_state);
